    ...
    <>
      <div className="info__wrapper">
        ...
        <p className="information__text">
          {t('mainInfo.informationText')} <span className="infoText__decor">{t('mainInfo.infoTextDecor')}</span> {t('mainInfo.separateText')} <span className="infoText__decor">{t('mainInfo.infoTextDecor_2')}</span> {t('mainInfo.informationText_2')} <span className="stores__decor">{t('mainInfo.store_1')}</span> {t('mainInfo.and')} <span className="stores__decor">{t('mainInfo.store_2')}</span>
        </p>
